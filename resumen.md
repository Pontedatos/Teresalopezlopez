...
Una de las configuraciones más importantes para trabjar fue la configuración de **Git** para poder trabajar en Github (online) desde mi directorio (local). Para ello: `git config --global user.name"Teresalopezlopez"`, y `git config --global user.email"100386353@alumnos.uc3m.es"`.

## Comandos utilizados y ejemplos
Primero listaré los comandos aprendidos más relevantes para aportar un ejemplo de su posible uso. Incluiré también algunas de las opciones y argumentos de los comandos más destacadas en el curso por lo que recuérdese que su estructura es comandos-opciones-argumentos. Entre estos siempre va un espacio. 
...
`git`
	...
	- `git status` -> saber en qué estado me encuentro y por dónde debo seguir.
...
### Caso práctico
Para representar la utilidad de los comandos recrearé cómo podría actualizar [mi repositorio](https://github.com/Teresalopezlopez/Practicas-Periodismo-Datos) de las prácticas de la asignatura con el fin de añadir la práctica 4 y actualizar las anteriores. Desde la temrinal en primer lugar preguntaría donde estoy y me cambiaría de directorio: 
> pwd
